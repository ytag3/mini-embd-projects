...
//interrupts
//can use do-while loop to write multiline macro //NOTES removed __ from second asm
#define INTERRUPT_DISABLE() 	do{__asm volatile ("MOV R0, #0x1"); asm volatile("MSR PRIMASK, R0");} while(0)	//use primask register
